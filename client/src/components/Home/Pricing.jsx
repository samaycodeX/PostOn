            ...
            <div className="max-w-6xl mx-auto px-4 sm:px-6">
                <div className="text-center mb-16">
                    ...
                    <h2 className="font-serif font-medium text-4xl sm:text-5xl leading-tight text-[#102E46]">
                        ...
                        <br />
                        <span className="text-[#78C6E3] italic">of growth</span>
                    </h2>
                    ...
                    {pricingPlans.map((plan) => (
                        <div
                            ...
                            className={`rounded-2xl border p-7 flex flex-col gap-6 relative ${
                                plan.highlight
                                    ? "bg-[#102E46] text-white border-[#183D5C] shadow-2xl shadow-sky-100"
                                    : "bg-white text-[#102E46] border-[#E8F1F5] shadow-sm"
                            }`}
                        >
                            {plan.highlight && (
                                <div className="absolute -top-3.5 left-1/2 -translate-x-1/2 bg-[#78C6E3] text-[#102E46] text-xs font-bold px-3.5 py-1.5 rounded-full">
                                    Most Popular
                                </div>
                            )}
                            ...
                            <Link
                                ...
                                className={`mt-auto text-center font-semibold text-sm px-6 py-3 rounded-full transition-colors ${
                                    plan.highlight
                                        ? "bg-white text-[#102E46] hover:bg-[#F8FCFE]"
                                        : "bg-[#102E46] text-white hover:bg-[#183D5C]"
                                }`}
                            >
                                {plan.cta}
                            </Link>
